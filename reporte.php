...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item active">
          <a class="nav-link" href="Reporte.php">MIS COMPRAS  <span class="sr-only">(current)</span></a>
       <li>
   </ul>
 </div>
</nav>
  ...
  <form action="reportes2.php" method="POST">
     <input type="number" placeholder="Ingrese su dni" name="dni" id="dni">
     <a href="Reportes2.php" target="_blank"> <button type="submit" class="btn btn-danger ml-2">Mis compras</button></a>
  </form>
 </div>
