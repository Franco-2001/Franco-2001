...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="Busqueda.php">INICIO  <span class="sr-only">(current)</span></a>
            </li>
        </ul>
      </div>
    </nav>
    ...
    <!---------FORMULARIO -------->
      <form class="form-inline cuerpo border rounded-pill bg-dark">
        <label class="sr-only text-light" for="inlineFormInputName2">Name</label>
        <input type="text"
        class="form-control mb-2 mr-sm-2 ml-2" id="inlineFormInputName2" placeholder="destino">
        ...
        <div class="input-group-text"></div>
          ...
          <input type="datetime-local" class="form-control" id="inlineFormInputGroupUsername2" placeholder="fecha de salida">
        </div>
        <div class="form-check mb-2 mr-sm-2">
          ...
          <a href="Busqueda.php"> <button type="button" class="btn btn-danger ml-2">BUSCAR</button></a>
        </div>
      </form>
    </div>
